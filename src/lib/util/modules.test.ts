...
test__load_modules('fail with load_module_failures', async () => {
	const path_bar1 = resolve('src/lib/util/fixtures/bar1');
	const path_bar2 = resolve('src/lib/util/fixtures/bar2');
	const path_baz1 = resolve('src/lib/util/fixtures/baz1');
	const path_baz2 = resolve('src/lib/util/fixtures/baz2');
