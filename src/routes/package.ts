		...
		},
		{
			...
			identifiers: [
				...
				},
				{
					...
					source_line: 54,
					type_signature:
						'(map_package_json: PackageJsonMapper, log: Logger, write?: boolean, dir?: string, exports_dir?: string): Promise<{ package_json: { [x: string]: unknown; name: string; ... 30 more ...; exports?: string | ... 2 more ... | undefined; } | null; changed: boolean; }>',
					return_type:
