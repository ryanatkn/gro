...
export const src_json = {
	...
	modules: {
		...
		'./package.js': {
			...
			declarations: [
				{name: 'package_json', kind: 'VariableDeclaration'},
				{name: 'src_json', kind: 'VariableDeclaration'},
			],
		},
		'./path.js': {
			path: 'path.ts',
		...
		'./src_json.js': {
			path: 'src_json.ts',
			declarations: [
				{name: 'Src_Module_Declaration', kind: 'VariableDeclaration'},
				{name: 'Src_Module', kind: 'VariableDeclaration'},
				{name: 'Src_Modules', kind: 'VariableDeclaration'},
				{name: 'Src_Json', kind: 'VariableDeclaration'},
				{name: 'Map_Src_Json', kind: 'InterfaceDeclaration'},
				{name: 'create_src_json', kind: 'VariableDeclaration'},
				{name: 'serialize_src_json', kind: 'VariableDeclaration'},
				{name: 'normalize_src_json', kind: 'VariableDeclaration'},
				{name: 'to_src_modules', kind: 'VariableDeclaration'},
			],
		},
		'./sveltekit_config.js': {
