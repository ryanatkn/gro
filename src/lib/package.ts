...
export const package_json = {
	...
	peerDependencies: {esbuild: '^0.19.5', svelte: '*'},
	devDependencies: {
	...
	modules: {
		...
		'./gen_module.js': {
			...
			declarations: [
				...
				{name: 'BasicGen_Module', kind: 'InterfaceDeclaration'},
				{name: 'SchemaGen_Module', kind: 'InterfaceDeclaration'},
				...
				{name: 'BasicGen_Module_Meta', kind: 'InterfaceDeclaration'},
				{name: 'SchemaGen_Module_Meta', kind: 'InterfaceDeclaration'},
				{name: 'load_gen_module', kind: 'VariableDeclaration'},
				{name: 'CheckGen_Module_Result', kind: 'TypeAliasDeclaration'},
