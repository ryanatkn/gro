...
export const package_json = {
	...
	modules: {
		...
		'./package_json.js': {
			...
			declarations: [
				{name: 'Package_Module_Declaration', kind: 'variable'},
				{name: 'Package_Module', kind: 'variable'},
				{name: 'Package_Modules', kind: 'variable'},
				...
				{name: 'Package_Json_Modules', kind: 'variable'},
				...
				{name: 'load_mapped_package_json', kind: 'function'},
				...
				{name: 'to_package_modules', kind: 'function'},
			],
		},
