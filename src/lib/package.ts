...
export const package_json: Package_Json = {
	...
	peerDependencies: {'@sveltejs/kit': '^2', esbuild: '^0.25', svelte: '^5', typescript: '^5'},
	...
	exports: {
		...
		'./disknode_helpers.js': {
			types: './dist/disknode_helpers.d.ts',
			default: './dist/disknode_helpers.js',
		},
		...
		'./filer_helpers.js': {types: './dist/filer_helpers.d.ts', default: './dist/filer_helpers.js'},
		'./filer.test_helpers.js': {
			types: './dist/filer.test_helpers.d.ts',
			default: './dist/filer.test_helpers.js',
		},
	...
	modules: {
		...
		'./constants.js': {
			...
			declarations: [
				...
				{name: 'DEFAULT_CONFIG_FILES', kind: 'variable'},
			],
		},
		'./deploy.task.js': {
			path: 'deploy.task.ts',
		...
		'./disknode_helpers.js': {
			path: 'disknode_helpers.ts',
			declarations: [
				{name: 'DISKNODE_MAX_CACHED_SIZE', kind: 'variable'},
				{name: 'disknode_get_extension', kind: 'function'},
				{name: 'disknode_is_typescript', kind: 'function'},
				{name: 'disknode_is_js', kind: 'function'},
				{name: 'disknode_is_svelte', kind: 'function'},
				{name: 'disknode_is_svelte_module', kind: 'function'},
				{name: 'disknode_is_importable', kind: 'function'},
				{name: 'disknode_update_kind_from_stats', kind: 'function'},
				{name: 'disknode_read_contents_direct', kind: 'function'},
		...
		'./filer_helpers.js': {
			path: 'filer_helpers.ts',
			declarations: [
				{name: 'filer_traverse_relationships', kind: 'function'},
				{name: 'Filer_Change_Type', kind: 'variable'},
				{name: 'Filer_Phase', kind: 'variable'},
				{name: 'Filer_Phase_Order', kind: 'variable'},
				{name: 'Filer_Expand_Strategy', kind: 'variable'},
				{name: 'Filer_Error_Strategy', kind: 'variable'},
				{name: 'Filer_Node_Kind', kind: 'variable'},
				{name: 'Filer_Invalidation_Intent_Type', kind: 'variable'},
				{name: 'Filer_Invalidation_Intent', kind: 'variable'},
				{name: 'Filer_Change', kind: 'variable'},
				...
				{name: 'filer_resolve_intent_disknodes', kind: 'function'},
			],
		},
		'./filer.test_helpers.js': {
			path: 'filer.test_helpers.ts',
			declarations: [
				{name: 'Mock_Watcher', kind: 'class'},
				{name: 'create_mock_stats', kind: 'function'},
				{name: 'Filer_Test_Context', kind: 'class'},
				{name: 'use_filer_test_context', kind: 'function'},
				{name: 'wait_for_batch', kind: 'function'},
				{name: 'TEST_PATHS', kind: 'variable'},
			],
		},
		'./filer.js': {
			path: 'filer.ts',
