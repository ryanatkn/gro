...
test('DEFAULT_SEARCH_EXCLUDER', () => {
	const assert_includes = (path: string, exclude: boolean) => {
		const msg = `should ${exclude ? 'exclude' : 'include '}: ${path}`;
		const b = (v: boolean) => (exclude ? !v : v);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`a/${path}/c`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`a/${path}/c/d.js`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`a/${path}/c/d.e.js`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`a/${path}/`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`a/${path}`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/a/${path}/c`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/a/${path}/c/d.js`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/a/${path}/c/d.e.js`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/a/${path}/`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/a/${path}`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/${path}/a`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/${path}/a/b.js`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/${path}/a/b.e.js`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/${path}/`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`/${path}`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`./${path}/a`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`./${path}/a/b.js`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`./${path}/a/b.c.js`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`./${path}/`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`./${path}`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`${path}/a`)), msg);
		assert.ok(b(DEFAULT_SEARCH_EXCLUDER.test(`${path}/a/b.js`)), msg);
