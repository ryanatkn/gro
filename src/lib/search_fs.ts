...
import type {File_Filter, Path_Info, Path_Filter} from './path.js';
...
export const search_fs = async (
	...
	const paths: Map<string, Path_Info> = new Map();
