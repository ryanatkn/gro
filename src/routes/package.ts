					...
					parameters: [
						{
							...
							type: 'Plugin<PluginContext<object>>[]',
							optional: false,
							description: '- accepts the same types as the return value of `CreateConfigPlugins`',
						},
						{
							name: 'new_plugin',
							type: 'Plugin<PluginContext<object>>',
		...
		},
		{
			...
			identifiers: [
				...
				},
				{
					...
					kind: 'function',
					source_line: 215,
					type_signature: '(found_tasks: FoundTasks, root_path?: PathId): Promise<LoadTasksResult>',
