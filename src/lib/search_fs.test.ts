...
test('search_fs basic behavior', () => {
	...
	const expected_files = [
		...
		'modules/re_exports.ts',
		'modules/nested_types.ts',
		'modules/function_exports.ts',
		'modules/export_specifiers.ts',
		'modules/export_precedence.ts',
		'modules/comprehensive_exports.ts',
		'modules/class_exports.ts',
		'modules/basic_exports.ts',
		'modules/arrow_functions.ts',
